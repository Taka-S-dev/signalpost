...
export const en = {
  ...
  empty: {
    ...
    elsewhere: "The hooks name a different copy of Signalpost →",
  },
  hints: {
    show: "show the panel",
  ...
  setup: {
    ...
    reset: "Reset",
    popup: "Open the list by itself",
    popupHint: "The bar appears either way, and pointing at it peeks. Approvals are the default because those are the ones holding a session up",
    popupPermission: "Approvals only",
    popupAll: "Anything",
    popupNever: "Never open it",
